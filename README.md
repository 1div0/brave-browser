...
This repository holds the build tools needed to build the Brave desktop browser for Linux on AArch64. In particular, it fetches and syncs code from the projects defined in `package.json` and `src/brave/DEPS`:
